...
const HomeFinancialServices = () => {
	...
	>
		...
		<br/>
		<br/>
		<p><strong>УВАГА! Товариство не надає споживчі кредити у розумінні Закону
			України &quot;Про споживче кредитування&quot;
		</strong></p>
		<p><strong> ТОВ «СЕНТ ПРО» не здійснює кредитування фізичних осіб та не
			здійснює
			врегулювання простроченої заборгованості фізичних осіб.</strong></p>
	</SplitBlocks>;
}
