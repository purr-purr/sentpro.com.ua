		...
		<section id="protection">
			...
			>
				<ul>
					...
					<li>
						Тел.: +38 (044) 486-54-86, +38 (063) 639-09-09 («Гаряча лінія»);
					</li>
					<li>
						Веб-сайт:
						...
						, Email:{' '}
						<a
							href="mailto:info@kyiv-dpss.gov.ua"
							target="_blank"
							rel="noreferrer"
						>
				...
				<p>
					...
					за посиланням в розділ «Захист прав споживачів» на сторінці офіційного
